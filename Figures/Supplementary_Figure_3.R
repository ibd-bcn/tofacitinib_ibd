...
## Supplementary Figure 3B: Dotplot per subset----------------------------------
# Myeloid
...
save_sizes(plot = dotplot_myeloids, filename = 'sup_3_dotplot_myeloids', device = 'jpeg')
save_sizes(plot = dotplot_myeloids, filename = 'sup_3_dotplot_myeloids', device = 'tiff')
save_sizes(plot = dotplot_myeloids, filename = 'sup_3_dotplot_myeloids', device = 'svg')
save_sizes(plot = dotplot_myeloids, filename = 'sup_3_dotplot_myeloids', device = 'pdf')

save_sizes(plot = umap_myeloids, filename = 'sup_3umap_myeloids', device = 'pdf')
save_sizes(plot = umap_myeloids, filename = 'sup_3umap_myeloids', device = 'jpeg')
save_sizes(plot = umap_myeloids, filename = 'sup_3umap_myeloids', device = 'tiff')
save_sizes(plot = umap_myeloids, filename = 'sup_3umap_myeloids', device = 'svg')
...
save_sizes(plot = dotplot_stroma, filename = 'sup_3_dotplot_stroma', device = 'jpeg')
save_sizes(plot = dotplot_stroma, filename = 'sup_3_dotplot_stroma', device = 'tiff')
save_sizes(plot = dotplot_stroma, filename = 'sup_3_dotplot_stroma', device = 'svg')
save_sizes(plot = dotplot_stroma, filename = 'sup_3_dotplot_stroma', device = 'pdf')

save_sizes(plot = umap_stroma, filename = 'sup_3umap_stroma', device = 'pdf')
save_sizes(plot = umap_stroma, filename = 'sup_3umap_stroma', device = 'jpeg')
save_sizes(plot = umap_stroma, filename = 'sup_3umap_stroma', device = 'tiff')
save_sizes(plot = umap_stroma, filename = 'sup_3umap_stroma', device = 'svg')
...
save_sizes(plot = dotplot_tcells, filename = 'sup_3_dotplot_tcells', device = 'jpeg')
save_sizes(plot = dotplot_tcells, filename = 'sup_3_dotplot_tcells', device = 'tiff')
save_sizes(plot = dotplot_tcells, filename = 'sup_3_dotplot_tcells', device = 'svg')
save_sizes(plot = dotplot_tcells, filename = 'sup_3_dotplot_tcells', device = 'pdf')

save_sizes(plot = umap_tcells, filename = 'sup_3umap_tcells', device = 'pdf')
save_sizes(plot = umap_tcells, filename = 'sup_3umap_tcells', device = 'jpeg')
save_sizes(plot = umap_tcells, filename = 'sup_3umap_tcells', device = 'tiff')
save_sizes(plot = umap_tcells, filename = 'sup_3umap_tcells', device = 'svg')
...
save_sizes(plot = dotplot_epi, filename = 'sup_3_dotplot_epi', device = 'jpeg')
save_sizes(plot = dotplot_epi, filename = 'sup_3_dotplot_epi', device = 'tiff')
save_sizes(plot = dotplot_epi, filename = 'sup_3_dotplot_epi', device = 'svg')
save_sizes(plot = dotplot_epi, filename = 'sup_3_dotplot_epi', device = 'pdf')

save_sizes(plot = umap_epi, filename = 'sup_3umap_epi', device = 'pdf')
save_sizes(plot = umap_epi, filename = 'sup_3umap_epi', device = 'jpeg')
save_sizes(plot = umap_epi, filename = 'sup_3umap_epi', device = 'tiff')
save_sizes(plot = umap_epi, filename = 'sup_3umap_epi', device = 'svg')
...
save_sizes(plot = dotplot_plasmas, filename = 'sup_3_dotplot_plasmas', device = 'jpeg')
save_sizes(plot = dotplot_plasmas, filename = 'sup_3_dotplot_plasmas', device = 'tiff')
save_sizes(plot = dotplot_plasmas, filename = 'sup_3_dotplot_plasmas', device = 'svg')
save_sizes(plot = dotplot_plasmas, filename = 'sup_3_dotplot_plasmas', device = 'pdf')

save_sizes(plot = umap_plasmas, filename = 'sup_3umap_plasmas', device = 'pdf')
save_sizes(plot = umap_plasmas, filename = 'sup_3umap_plasmas', device = 'jpeg')
save_sizes(plot = umap_plasmas, filename = 'sup_3umap_plasmas', device = 'tiff')
save_sizes(plot = umap_plasmas, filename = 'sup_3umap_plasmas', device = 'svg')
...
save_sizes(plot = dotplot_cycling, filename = 'sup_3_dotplot_cycling', device = 'jpeg')
save_sizes(plot = dotplot_cycling, filename = 'sup_3_dotplot_cycling', device = 'tiff')
save_sizes(plot = dotplot_cycling, filename = 'sup_3_dotplot_cycling', device = 'svg')
save_sizes(plot = dotplot_cycling, filename = 'sup_3_dotplot_cycling', device = 'pdf')

save_sizes(plot = umap_cycling, filename = 'sup_3umap_cycling', device = 'pdf')
save_sizes(plot = umap_cycling, filename = 'sup_3umap_cycling', device = 'jpeg')
save_sizes(plot = umap_cycling, filename = 'sup_3umap_cycling', device = 'tiff')
save_sizes(plot = umap_cycling, filename = 'sup_3umap_cycling', device = 'svg')
