...
sup4_M0R <- volcano_plot(cluster, comp, genes_up, genes_down)

print(sup4_M0R)

save_sizes(plot =sup4_M0R , filename = 'sup4_M0R', device = 'jpeg')
save_sizes(plot = sup4_M0R, filename = 'sup4_M0R', device = 'tiff')
save_sizes(plot = sup4_M0R, filename = 'sup4_M0R', device = 'svg')
save_sizes(plot = sup4_M0R, filename = 'sup4_M0R', device = 'pdf')
...
sup4_IDAR <- volcano_plot(cluster, comp, genes_up, genes_down)

print(sup4_IDAR)

save_sizes(plot =sup4_IDAR , filename = 'sup4_IDAR', device = 'jpeg')
save_sizes(plot = sup4_IDAR, filename = 'sup4_IDAR', device = 'tiff')
save_sizes(plot = sup4_IDAR, filename = 'sup4_IDAR', device = 'svg')
save_sizes(plot = sup4_IDAR, filename = 'sup4_IDAR', device = 'pdf')
...
sup4_M1NR <- volcano_plot(cluster, comp, genes_up, genes_down)

print(sup4_M1NR)

save_sizes(plot =sup4_M1NR , filename = 'sup4_M1NR', device = 'jpeg')
save_sizes(plot = sup4_M1NR, filename = 'sup4_M1NR', device = 'tiff')
save_sizes(plot = sup4_M1NR, filename = 'sup4_M1NR', device = 'svg')
save_sizes(plot = sup4_M1NR, filename = 'sup4_M1NR', device = 'pdf')
...
sup4_M0NR <- volcano_plot(cluster, comp, genes_up, genes_down)

print(sup4_M0NR)

save_sizes(plot =sup4_M0NR , filename = 'sup4_M0NR', device = 'jpeg')
save_sizes(plot = sup4_M0NR, filename = 'sup4_M0NR', device = 'tiff')
save_sizes(plot = sup4_M0NR, filename = 'sup4_M0NR', device = 'svg')
save_sizes(plot = sup4_M0NR, filename = 'sup4_M0NR', device = 'pdf')
...
sup4_IDANR <- volcano_plot(cluster, comp, genes_up, genes_down)

print(sup4_IDANR)

save_sizes(plot =sup4_IDANR , filename = 'sup4_IDANR', device = 'jpeg')
save_sizes(plot = sup4_IDANR, filename = 'sup4_IDANR', device = 'tiff')
save_sizes(plot = sup4_IDANR, filename = 'sup4_IDANR', device = 'svg')
save_sizes(plot = sup4_IDANR, filename = 'sup4_IDANR', device = 'pdf')
